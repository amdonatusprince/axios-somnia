...
export default function EmployerBillingPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionHeader
        title="Billing"
        description="Monitor subscription tier, payroll throughput, x402 API spend, and yield contribution across this employer workspace."
        action={
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-5">
          <div className="flex items-center gap-2 text-[var(--text-muted)]">
            ...
            <p className="text-xs uppercase tracking-[0.14em]">x402 spend</p>
          </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_1fr]">
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-5 sm:p-6">
          ...
          <div className="mt-5 space-y-4">
            ...
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-base)] p-4">
              <p className="text-xs uppercase tracking-[0.14em] text-[var(--text-muted)]">x402 sessions</p>
        ...
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] p-5 sm:p-6">
          ...
          <div className="mt-5 space-y-3 text-sm leading-6 text-[var(--text-secondary)]">
            <p>Billing in this build is derived from real payroll, x402 session, and yield activity already stored in Axios.</p>
