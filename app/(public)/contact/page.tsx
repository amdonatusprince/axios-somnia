...
export const metadata = { title: 'Contact | Axios' }
    ...
    <div className="space-y-16">
      ...
      <div className="grid sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
        <div className="p-8 rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] text-center space-y-4">
          ...
          <p className="text-[var(--text-primary)] font-semibold">support@axios.xyz</p>
        </div>
        ...
        <div className="p-8 rounded-2xl border border-[var(--border-default)] bg-[var(--bg-surface)] text-center space-y-4">
          ...
          <p className="text-[var(--text-primary)] font-semibold">hello@axios.xyz</p>
        </div>
      </div>
    </div>
  )
