...
export const metadata = { title: 'Privacy Policy | Axios' }
    ...
    <article className="prose prose-invert max-w-none">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            Your data is used strictly to provide and improve the Axios payroll infrastructure:
          </p>
          <ul className="list-disc pl-6 mt-4 space-y-2 text-[var(--text-secondary)]">
        ...
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            Depending on your jurisdiction, you may have the right to access, correct, or delete your personal data. You can manage most of your account settings directly within the Axios dashboard.
          </p>
        </section>
      </div>
    </article>
