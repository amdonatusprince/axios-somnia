...
export const metadata = { title: 'Cookie Policy | Axios' }
    ...
    <article className="prose prose-invert max-w-none">
      ...
      <div className="space-y-12">
        ...
        <section>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-[var(--text-secondary)]">Help us understand how visitors interact with Axios so we can refine our user interface and performance.</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            Most web browsers allow you to control cookies through their settings. Please note that disabling essential cookies may impact your ability to use certain features of the Axios dashboard.
          </p>
        </section>
      </div>
    </article>
