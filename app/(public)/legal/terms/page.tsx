...
export const metadata = { title: 'Terms of Service | Axios' }
      ...
      <div className="space-y-12">
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            By accessing or using Axios, you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use our payroll infrastructure or services.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            Axios provides AI-native global payroll infrastructure on the Tempo network. This includes embedded wallet provisioning, compliance screening, salary streaming, and gas sponsorship.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-[var(--text-secondary)] leading-relaxed">
            Axios is provided "as is" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages arising from the use of our on-chain infrastructure.
          </p>
        </section>
      </div>
    </article>
