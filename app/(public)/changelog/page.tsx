...
export const metadata = { title: 'Changelog | Axios' }
  ...
  return (
    <div className="space-y-16">
      <div className="max-w-xl">
        ...
        <p className="text-lg text-[var(--text-secondary)]">The latest updates, improvements, and fixes for the Axios infrastructure.</p>
      </div>
