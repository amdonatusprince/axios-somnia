...
export const metadata = { title: 'Status | Axios' }
    ...
    <div className="space-y-14">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-[var(--text-secondary)]">
          Axios publishes product health here for employers, employees, and integration partners monitoring core payroll infrastructure.
        </p>
      </section>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-7 text-[var(--text-secondary)]">
              When any partner dependency degrades, Axios updates this page first and mirrors major incidents to customer support. For urgent payroll questions, contact <span className="font-medium text-[var(--text-primary)]">support@axios.xyz</span>.
            </p>
          </div>
        </div>
      </section>
