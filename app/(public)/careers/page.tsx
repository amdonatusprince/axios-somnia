...
export const metadata = { title: 'Careers | Axios' }
    ...
    <div className="space-y-16">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <section className="space-y-6">
          <h2 className="text-xl font-bold text-[var(--text-primary)]">Why Axios?</h2>
          <p className="text-[var(--text-secondary)] leading-relaxed">
            We are a distributed team of engineers, designers, and thinkers who are obsessed with solving hard problems. At Axios, you'll have the autonomy to make a massive impact and build software that genuinely shifts the paradigm of how people get paid.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-[var(--text-secondary)]">
            <li>Remote-first, async culture</li>
            <li>Paid in stablecoins (via Axios!)</li>
