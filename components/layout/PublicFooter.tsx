...
const FOOTER_COLS = [
  ...
  },
  {
    label: 'Developers',
    links: [
      { label: 'API reference', href: 'https://docs.axios.xyz/docs', external: true },
      { label: 'MPP endpoints', href: 'https://docs.axios.xyz/docs/mpp-api/overview', external: true },
      { label: 'AgentCash', href: 'https://docs.axios.xyz/docs/integrations/agentcash', external: true },
      { label: 'GitHub', href: 'https://github.com/winsznx/axios', external: true },
    ],
  },
  {
    label: 'Company',
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center gap-4">
            <a
              href="https://x.com/axios_xyz/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/20 hover:text-white/60 transition-colors"
              aria-label="Axios on X"
            >
            ...
            <a
              href="https://github.com/winsznx/axios"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/20 hover:text-white/60 transition-colors"
              aria-label="Axios on GitHub"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
