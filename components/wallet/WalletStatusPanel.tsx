      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-base)] p-4">
          ...
          {sessionAddress ? (
            ...
            <p className="mt-3 text-sm text-[var(--text-secondary)]">No wallet surfaced in the current session.</p>
          )}
        </div>
        ...
        <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-base)] p-4">
          ...
          {storedAddress ? (
            ...
            <p className="mt-3 text-sm text-[var(--text-secondary)]">No wallet has been saved in Axios yet.</p>
          )}
        </div>
      </div>
