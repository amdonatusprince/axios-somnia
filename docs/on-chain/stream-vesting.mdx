...
Standard payroll usually operates in discrete, bi-weekly or monthly batches. Axios introduces `StreamVesting` to allow employers to pay their teams continually—by the second—replacing stagnant ledgers with fluid capital routing.
...
4. Immediately transfers the liquid sUSDC stablecoins to the employee's wallet with the correct standard payroll memo attached.
