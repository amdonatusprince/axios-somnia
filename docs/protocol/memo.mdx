...
description: "32-byte payroll memos and compliance checks on Mezo."
---

On **Mezo testnet**, Axios attaches **32-byte memos** to **MUSD** ERC-20 transfers so payroll metadata is auditable on-chain. The same structural ideas apply as on other stacks that used TIP-20–style memo fields.
